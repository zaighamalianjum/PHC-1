...
export const ROLE_RIGHTS: Record<User['Role'], UserRight[]> = {
  Administrator: [
    ...
    { MenuID: 'query_handler', MenuName: 'Query Handler & System Audit Desk', Status: true, AddRec: true, PostRec: true, CancelPosted: true, PrintRec: true, ExportRec: true },
