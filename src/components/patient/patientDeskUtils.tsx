...
/**
 * Automatically requests browser full screen mode if not currently active.
 * Handles standard and vendor-prefixed browser APIs safely with user gesture propagation.
 */
export function ensureAppFullScreen(): void {
  try {
    const isFullScreen = !!(
