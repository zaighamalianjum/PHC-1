...
fs.mkdirSync('src/components/erp/tabs', { recursive: true });
fs.mkdirSync('src/components/erp/modals', { recursive: true });

// ==========================================
// 1. ERP UTILS
// ==========================================
const erpUtilsContent = `import React, { useCallback } from 'react';
import { ErpPurchaseOrder, ErpGrn, ErpVendor } from '../../types';
...
`;
fs.writeFileSync('src/components/erp/erpUtils.tsx', erpUtilsContent, 'utf8');

console.log('Base utils written.');
